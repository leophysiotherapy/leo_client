...
const Eval: FC = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <iframe className={styles.frame} src="https://docs.google.com/spreadsheets/d/e/2PACX-1vR71C2gAf9uWT6mRY0J8GeL0-bN73-9iuhHxDls_f73-GWr0N5FtyQCDuG4fEZnoQ2dWxBVEWNVmW8B/pubhtml?widget=true&amp;headers=false"></iframe>
        </div>
    )
}
