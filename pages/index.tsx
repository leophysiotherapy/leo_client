...
const Home: FC = ({ userID }: any) => {
  ...
  return (
    <>
      <Head>
        <title>Leonardo: Physical Theraphy Rehabilitation Clinic</title>
      ...
      <div className={styles.container}>
        <div className={styles.tagline}>
          ...
          {cookies ? <button onClick={() => router.push("/auth/login")}>BOOK NOW</button> : <button onClick={() => router.push("/patient/appointment/facetoface")}>BOOK NOW</button>}
          {
